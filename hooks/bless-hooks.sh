...
TRACKED=(resource-check.sh ram-monitor.sh resource-guard.sh superboost-banner.sh superboost-statusline.sh bless-hooks.sh safety-guard.sh gitnexus-refresh.sh superboost-secrets.sh)
